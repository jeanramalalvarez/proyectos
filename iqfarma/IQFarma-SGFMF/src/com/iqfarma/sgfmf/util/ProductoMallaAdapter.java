 ...
 * @since 16/09/2014
 * */
public class ProductoMallaAdapter extends ArrayAdapter<Producto> {

	private Context context;
	private int layoutResourceId;

	public ProductoMallaAdapter(Context context, int layoutResourceId, List<Producto> productos) {
