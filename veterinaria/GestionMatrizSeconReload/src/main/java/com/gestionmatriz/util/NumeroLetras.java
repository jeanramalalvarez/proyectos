...
public class NumeroLetras {
	...
	public String convertirLetras(String numero){
...
//		for(int i=0;i<aux.length;i++){
			...
			try{
				...
				Integer e= Integer.parseInt(aux[0]);
//                                System.out.println(" e :"+e);
                                numero=(""+decmillon(e)).concat(" y ".concat(aux[1]+"/100"));
//				numero=numero.replace(aux[0], decmillon(e)).concat(" con ".concat(aux[1]+"/100"));
...
//		}
		...
		return "SON : ".concat(numero.concat(" NUEVOS SOLES")).toUpperCase();
	}
        
        public String convertirLetrasFactura(String numero){
...
//		}
		...
		return numero.concat(" NUEVOS SOLES").toUpperCase();
	}
        
        
//        
//        public static void main(String[] args) throws Exception {
//            System.out.println("Numero :"+new NumeroLetras().convertirLetras("156987,50").concat(" nuevos soles"));
//           
//    }
}
