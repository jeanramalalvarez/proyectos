...
INSERT INTO `pedido` (`nu_pedi`,`fe_pedi`,`de_prof_invo`,`id_tipo_hldo`,`no_carg`,`nu_cost_cif`,`nu_cost_tota`,`nu_prec_vent`,`nu_cant_pedi`,`nu_tota_pedi`,`nu_adel_pedi`,`co_usua_crea`,`fe_usua_crea`,`co_usua_modi`,`fe_usua_modi`,`in_regi_acti`,`de_obse_pedi`,`co_unid_medi`,`co_marc_prod`,`id_bnco`) VALUES 
 ...
 (95,'2012-11-16','DRYTDRT',2,'WERTWE','142.00','187.44','187.94','1.78','252.76','37.91',NULL,NULL,NULL,NULL,'1','WRTWR','','',4);
...
CREATE TABLE `tipo_transaccion` (
  ...
  `in_regi_acti` varchar(45) DEFAULT NULL COMMENT 'Indicador de Registro = "1" - Activo, "0" - Inactivo\n',
  `fe_usua_crea` datetime DEFAULT NULL,
  `co_usua_crea` varchar(20) DEFAULT NULL,
  `fe_usua_modi` datetime DEFAULT NULL,
  `co_usua_modi` varchar(20) DEFAULT NULL,
...
INSERT INTO `tipo_transaccion` (`id_tipo_tran`,`de_tran`,`in_regi_acti`,`fe_usua_crea`,`co_usua_crea`,`fe_usua_modi`,`co_usua_modi`,`co_tipo_tran`) VALUES 
 (1,'Compra por Importación','1',NULL,NULL,NULL,NULL,''),
 (2,'Compra Local','1',NULL,NULL,NULL,NULL,NULL);
