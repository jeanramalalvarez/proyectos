...
INSERT INTO `banco` (`id_bnco`,`no_bnco`,`in_regi_acti`,`co_usua_crea`,`fe_usua_crea`,`de_term_crea`,`co_usua_modi`,`fe_usua_modi`,`de_term_modi`) VALUES 
 (1,'Banco de Credito','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (2,'Banco Continental','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (3,'Banco Scotiabank','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (4,'Banco de la Nacion','1',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `hilado` (
  ...
  `co_esta_pedi` char(1) DEFAULT NULL COMMENT 'CÃ³digo de estado del pedido.',
  `in_regi_acti` char(1) NOT NULL DEFAULT '1',
  `co_usua_crea` varchar(20) DEFAULT NULL,
  `fe_usua_crea` datetime DEFAULT NULL,
  `de_term_crea` varchar(15) DEFAULT NULL,
...
INSERT INTO `marca` (`id_mrca`,`de_mrca`,`in_tipo_prod`,`in_regi_acti`,`co_usua_crea`,`fe_usua_crea`,`de_term_crea`,`co_usua_modi`,`fe_usua_modi`,`de_term_modi`) VALUES 
 (1,'MARCA HILADO 1','H','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (2,'MARCA HILADO 2','H','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (3,'MARCA TELA 1','T','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (4,'MARCA TELA 2','T','1',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `pedido` (`nu_pedi`,`id_unid_medi`,`id_mrca`,`id_bnco`,`fe_pedi`,`de_prof_invo`,`id_tipo_hldo`,`no_carg`,`nu_cost_cif`,`nu_cost_tota`,`nu_prec_vent`,`nu_cant_pedi`,`nu_tota_pedi`,`nu_adel_pedi`,`de_obse_pedi`,`in_regi_acti`,`co_usua_crea`,`fe_usua_crea`,`de_term_crea`,`co_usua_modi`,`fe_usua_modi`,`de_term_modi`) VALUES 
 (82,NULL,NULL,2,'2012-11-15','10',1,'SDFG','10.00','13.20','13.70','10.00','0.00','0.00','SDFG','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (83,NULL,NULL,4,'2012-11-15','SDFGSD',1,'SDFG','10.00','13.20','13.70','10.00','0.00','0.00','SDFG','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (84,NULL,NULL,1,'2012-11-15','SSDFG',1,'SDFG','102.00','134.64','135.14','10.00','0.00','0.00','SDFG','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (85,NULL,NULL,3,'2012-11-15','DSDF',1,'ASDF','10.00','13.20','13.70','10.00','100.00','15.00','ASDFASD','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (86,NULL,NULL,4,'2012-11-15','GH',2,'ASDF','1.00','1.32','1.82','10.00','0.00','0.00','ASDF','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (87,NULL,NULL,3,'2012-11-15','DSFG',2,'ASDF','10.00','13.20','13.70','10.00','0.00','0.00','ASDFASD','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (88,NULL,NULL,2,'2012-11-16','SFG',1,'SDFG','10.00','13.20','13.70','10.00','0.00','0.00','SDFG','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (89,NULL,NULL,2,'2012-11-17','10',1,'10','50.00','66.00','66.50','1000.00','50000.00','7500.00','10','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (90,NULL,NULL,3,'2012-11-16','ASDF',2,'ASDF','3.00','3.96','4.46','10.00','0.00','0.00','ASDF','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (91,NULL,NULL,1,'2012-11-16','VVVV',2,'HHHHHH','5.00','6.60','7.10','10.00','0.00','0.00','ADSF','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (92,NULL,NULL,1,'2012-11-16','ADSF',1,'ASDF','10.00','13.20','13.70','10.00','0.00','0.00','ASDF','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (93,NULL,NULL,2,'2012-11-16','ASDF',2,'ADSF','1.00','1.32','1.82','1.00','0.00','0.00','ADFA','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (94,NULL,NULL,3,'2012-11-16','ASDF',1,'ASDF','3.00','3.96','4.46','10.00','0.00','0.00','ASDF','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (95,NULL,NULL,4,'2012-11-16','DRYTDRT',2,'WERTWE','142.00','187.44','187.94','1.78','252.76','37.91','WRTWR','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (96,NULL,NULL,4,'2012-11-17','ASDF',2,'SADF','10.00','13.20','13.70','10.00','100.00','15.00','ASDF','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (97,NULL,NULL,2,'2012-11-17','10',1,'10','10.00','13.20','13.70','10.00','100.00','15.00','10','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (98,NULL,NULL,4,'2012-11-17','FDS',2,'SDFG','10.00','13.20','13.70','10.00','100.00','15.00','SDFG','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (99,2,1,2,'2012-11-17','ASDF',1,'ASDF','10.00','13.20','13.70','10.00','100.00','15.00','ASDF','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (100,2,1,2,'2012-11-17','ASDF, ASDF',1,'ASDF','10.00','13.20','13.70','10.00','100.00','15.00','ASDF','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (101,1,2,4,'2012-11-17','DD, DD',2,'DDD','5.00','6.60','7.10','324.00','1620.00','243.00','DDDD','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (102,1,2,4,'2012-11-18','ASDF, ASDF, ASDF, ASDF',2,'ASDFASDF','5.00','6.60','7.10','20.00','100.00','15.00','ASDFASDF','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (103,2,2,4,'2012-11-18','SDHSDF',1,'SDFG','10.00','13.20','13.70','10.00','100.00','15.00','SDFGSDFG','0',NULL,NULL,NULL,NULL,NULL,NULL),
 (104,1,1,3,'2012-11-18','JEAN',2,'JEAN','10.00','13.20','13.70','10.00','100.00','15.00','JEAN','0',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `tipo_hilado` (`id_tipo_hldo`,`co_tipo_hldo`,`de_hldo`,`de_titu_hldo`,`in_regi_acti`,`co_usua_crea`,`fe_usua_crea`,`de_term_crea`,`co_usua_modi`,`fe_usua_modi`,`de_term_modi`) VALUES 
 (1,'HLO2410001','Polyester Texturizado 24/1','24/1','1','rmarquez',NULL,NULL,NULL,NULL,NULL),
 (2,'POL3610001','Polyester Texturizado 36/1','36/1','1','rmarquez',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `tipo_tela` (
  ...
  `co_proc` char(1) DEFAULT NULL COMMENT 'Codigo de proceso= \\"C\\" Crudo, \\"T\\" TeÃ±ido.',
  `in_regi_acti` char(1) NOT NULL DEFAULT '1',
  `co_usua_crea` varchar(20) DEFAULT NULL,
  `fe_usua_crea` datetime DEFAULT NULL,
  `de_term_crea` varchar(15) DEFAULT NULL,
...
INSERT INTO `tipo_transaccion` (`id_tipo_tran`,`de_tran`,`co_tipo_tran`,`in_regi_acti`,`fe_usua_crea`,`co_usua_crea`,`de_term_crea`,`fe_usua_modi`,`co_usua_modi`,`de_term_modi`) VALUES 
 (1,'Compra por Importacion','','1',NULL,NULL,NULL,NULL,NULL,NULL),
 (2,'Compra Local',NULL,'1',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `unidad_medida` (`id_unid_medi`,`co_unid_medi`,`de_unid_medi`,`in_regi_acti`,`co_usua_crea`,`fe_usua_crea`,`de_term_crea`,`co_usua_modi`,`fe_usua_modi`,`de_term_modi`,`in_tipo_prod`) VALUES 
 (1,'KG','KILOGRAMO','1',NULL,NULL,NULL,NULL,NULL,NULL,'H'),
 (2,'UN','UNIDAD','1',NULL,NULL,NULL,NULL,NULL,NULL,'H'),
 (3,'RL','ROLLO','1',NULL,NULL,NULL,NULL,NULL,NULL,'T');
...
INSERT INTO `usuario` (`id_usua`,`co_usua`,`de_pass_usua`,`in_regi_acti`,`fe_usua_crea`,`co_usua_crea`,`de_term_crea`,`fe_usua_modi`,`co_usua_modi`,`de_term_modi`) VALUES 
