 ...
 * @author YESM
 */
public class VerificationHuella extends JDialog {
    ...
    public VerificationHuella(Frame owner, EnumMap<DPFPFingerIndex, DPFPTemplate> templates, int farRequested) {
		super(owner, true);
		...
		verificationControl.addVerificationListener(new DPFPVerificationListener()
		{
			public void captureCompleted(DPFPVerificationEvent e) throws DPFPVerificationVetoException
			{
				final DPFPVerification verification = 
					DPFPGlobal.getVerificationFactory().createVerification(VerificationHuella.this.farRequested);
				...
				for (DPFPTemplate template : VerificationHuella.this.templates.values()) {
