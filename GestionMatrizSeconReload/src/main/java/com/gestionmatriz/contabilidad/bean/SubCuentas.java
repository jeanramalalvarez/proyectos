...
public class SubCuentas {
    ...
    private int int_idSubcuentas;
    private int int_idCuentas;
    private int int_nroSubcuentas;  
    ...
    public int getInt_idSubcuentas() {
        return int_idSubcuentas;
    }

    public void setInt_idSubcuentas(int int_idSubcuentas) {
        this.int_idSubcuentas = int_idSubcuentas;
    }

    public int getInt_nroSubcuentas() {
        return int_nroSubcuentas;
    }

    public void setInt_nroSubcuentas(int int_nroSubcuentas) {
        this.int_nroSubcuentas = int_nroSubcuentas;
    }
