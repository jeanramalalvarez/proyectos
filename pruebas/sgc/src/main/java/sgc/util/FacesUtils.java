...
public class FacesUtils {
	...
	public static HttpSession getSession(boolean active){
		return (HttpSession) getExternalContext().getSession(active);
	}
	...
	public static String getMensaje(String key, String... args) {
		try {
			...
			ResourceBundle res = context.getApplication().getResourceBundle(context, "mensajes");
